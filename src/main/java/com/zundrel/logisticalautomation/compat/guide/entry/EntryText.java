package com.zundrel.logisticalautomation.compat.guide.entry;
...
public class EntryText extends EntryResourceLocation {
    ...
    public EntryText(List<IPage> pageList, String unlocEntryName, boolean unicode) {
        super(pageList, unlocEntryName, new ResourceLocation("logisticalautomationguide", "textures/gui/bullet_point.png"), unicode);
    }
